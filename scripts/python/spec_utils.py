#spec_utils.py @ScriptDir & "\installs\UVR\uvr-main\uvr5_pack\lib_v5\spec_utils.py"
import os
import librosa
import numpy as np
...
def wave_to_spectrogram(wave, hop_length, n_fft, mid_side=False, mid_side_b2=False, reverse=False, overlap=0.0):
    # Adjust hop_length based on overlap
    window_size = n_fft
    hop_length = int(window_size * (1 - overlap)) if overlap > 0 else hop_length
...
def wave_to_spectrogram_mt(wave, hop_length, n_fft, mid_side=False, mid_side_b2=False, reverse=False, overlap=0.0):
    import threading
