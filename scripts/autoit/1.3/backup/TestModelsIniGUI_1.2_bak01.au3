...
#include <Array.au3>
#include <File.au3>
#include <ComboConstants.au3>  ; For $CBN_SELCHANGE
...
Global $idInputBrowseButton, $idOutputBrowseButton  ; Add IDs for browse buttons
...
Func CreateGUI()
    ...
    $idOutputDir = GUICtrlCreateInput(@ScriptDir & "\stems", 110, 100, 400, 20)  ; Set default output directory
...
Func LoadModels()
    ...
    UpdateModelSettings($aSections[1])  ; Initialize settings for the default selected model
EndFunc
...
Func RunSeparation()
    ...
    ; Get model settings from models.ini
    Local $sCmd = ""
    Local $sEnvPath = ""
    Local $sPythonScript = ""
    ...
    ; Resolve EnvPath and PythonScript
    ...
    ; Substitute placeholders in CommandLine
    ...
    ; Handle denoise flag: remove -d if Denoise=False
