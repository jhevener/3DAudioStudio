...
Func RunSeparation()
    ...
    While ProcessExists($iPID)
        ...
        If $sLine <> "" Then
            $sOutputText &= $sLine
            ; Parse progress bar up to and including the "|" from lines like "Processing:  67%|######6   | 12/18 [02:29<01:15, 12.66s/it]"
            If StringInStr($sLine, "Processing:") Then
                ...
                EndIf
            EndIf
            ; Update GUI with the latest progress line, replacing the previous one
