...
Global $hGUI, $hInputListView, $hOutputListView, $hBatchList, $hModelCombo
...
Global $hGraphicGUI, $hDC, $hGraphics, $hBrushGray, $hBrushTeal, $hBrushGreen, $hBrushYellow, $hPen
...
Func _IsModelCompatibleWithApp($sModel, $sApp)
...
Func _ListViewHandler($hWnd, $iMsg, $wParam, $lParam)
